...
const translations = {
  en: {
    ...
    heroTitle:
      "Install OpenClaw and launch your first AI agent without losing hours to config and terminal issues.",
    heroSub:
      "Practical Teams session to install OpenClaw, connect models and tools, fix setup errors, and get to a working agent on Windows, macOS, or Linux.",
    heroCtaPrimary: "Book guided setup",
    ...
    panelTitle: "From zero to working",
  ...
  it: {
    ...
    heroTitle: "Installa OpenClaw e lancia il tuo primo agente AI senza perdere ore tra configurazioni e terminale.",
    heroSub:
      "Sessione pratica su Teams per installare OpenClaw, collegare modelli e tool, risolvere errori di setup e arrivare a un agente davvero funzionante su Windows, macOS o Linux.",
    heroCtaPrimary: "Prenota il setup guidato",
    ...
    panelTitle: "Da zero a operativo",
  ...
  ar: {
    ...
    heroTitle: "ثبّت OpenClaw وأطلق أول وكيل ذكاء اصطناعي لديك من دون إضاعة ساعات في الإعداد والطرفية.",
    heroSub:
      "جلسة عملية عبر Teams لتثبيت OpenClaw وربط النماذج والأدوات وحل أخطاء الإعداد والوصول إلى وكيل يعمل فعلاً على Windows أو macOS أو Linux.",
    heroCtaPrimary: "احجز الإعداد الموجّه",
    ...
    panelTitle: "من الصفر إلى التشغيل",
