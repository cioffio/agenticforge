...
const translations = {
  en: {
    ...
    heroBullet3: "Agent template based on your industry",
    heroBullet4:
      "Dedicated sessions for product idea review and agent improvement",
    panelTitle: "Session runbook",
    panelStep1Title: "Technical pre-check",
    panelStep1Body: "Review hardware, cloud, and required accounts",
    panelStep2Title: "Guided installation",
    panelStep2Body: "OpenClaw or agent stack setup with a recommended architecture",
    panelStep3Title: "Personal agent",
    panelStep3Body:
      "Prompts, policies, and operational routines tailored to you",
    panelStep4Title: "Toolkit delivery",
    panelStep4Body: "Checklist, backup plan, and 30-day growth roadmap",
    ...
    whyTitle:
      "Interest in AI agents is rising fast, but proper setup and strategy are still the real filters.",
    whyBody:
      "Many people start from hype and end up with fragile workflows, messy prompts, and unclear next steps. Consulting reduces early mistakes and helps turn ideas into stable agents with a concrete operational role.",
    riskTitle: "What you avoid with expert guidance",
    risk1: "Fragile installations that break after the first update",
    risk2: "Overly permissive access to personal or company files",
    risk3: "Unnecessary cloud costs caused by poor configuration",
    risk4:
      "Agents that stay useless because they are not aligned with your real processes",
    offerEyebrow: "What is included",
    offerTitle:
      "From setup to execution: practical agents for operations, support, research, and growth.",
    feat1Title: "Personal architecture",
    feat1Body:
      "We design the setup around your case: freelancer, marketing team, law firm, ecommerce, or technical department.",
    feat2Title: "Live assisted installation",
    feat2Body:
      "Screen sharing on Teams and step-by-step setup until the agent completes its first real task.",
    feat3Title: "Essential hardening",
    feat3Body:
      "Data segmentation, minimum permissions, backup, and best practices to reduce operational risk.",
    feat4Title: "Useful integrations",
    feat4Body:
      "We connect the tools you already use: email, documents, CRM, or internal knowledge base.",
    feat5Title: "Custom agent template",
    feat5Body:
      "We create a first agent calibrated to your goals, with reusable prompts and operating rules.",
    feat6Title: "30-day roadmap",
    feat6Body:
      "You leave the call with a concrete improvement plan, without depending forever on external support.",
    agentsEyebrow: "What agents can do",
    agentsTitle:
      "Agents can save time, reduce repetition and support decisions when they are designed around real workflows.",
    ...
    processTitle: "From first contact to a working agent in 4 steps.",
    step1Title: "Technical brief",
    step1Body:
      "We collect goals, devices, and technical level, then define stack and priorities.",
    step2Title: "Teams session",
    step2Body:
      "Live installation with error handling, resource optimization, and final validation.",
    step3Title: "Custom agent setup",
    step3Body:
      "We define the role, limits, tone, and recurring tasks of your first agent.",
    step4Title: "Delivery + follow-up",
    step4Body:
      "You receive an operational checklist, useful files, and short post-session support for refinements.",
  ...
  it: {
    ...
    heroBullet3: "Template agente in base al tuo settore",
    heroBullet4:
      "Sessioni dedicate a review idee prodotto e miglioramento agenti",
    panelTitle: "Runbook della sessione",
    panelStep1Title: "Pre-check tecnico",
    panelStep1Body: "Verifica hardware, cloud e account necessari",
    panelStep2Title: "Installazione guidata",
    panelStep2Body: "Setup OpenClaw o stack agentico con architettura consigliata",
    panelStep3Title: "Agente personale",
    panelStep3Body: "Prompt, policy e routine operative dedicate",
    panelStep4Title: "Consegna toolkit",
    panelStep4Body: "Checklist, backup plan e piano crescita 30 giorni",
    ...
    whyTitle:
      "L'interesse per gli agenti AI cresce in fretta, ma setup e strategia restano il vero filtro.",
    whyBody:
      "Molti partono dall'hype e finiscono con flussi fragili, prompt confusi e nessuna direzione chiara. La consulenza riduce errori iniziali e trasforma idee vaghe in agenti stabili con un ruolo operativo concreto.",
    riskTitle: "Cosa eviti con una guida esperta",
    risk1: "Installazioni fragili che si rompono al primo aggiornamento",
    risk2: "Accessi troppo permissivi su file personali e aziendali",
    risk3: "Costi cloud inutili per configurazioni non ottimizzate",
    risk4: "Agenti poco utili perché non allineati ai tuoi processi reali",
    offerEyebrow: "Cosa ottieni nella consulenza",
    offerTitle: "Dal setup all'esecuzione: agenti pratici per operations, supporto, ricerca e crescita.",
    feat1Title: "Architettura personale",
    feat1Body:
      "Disegniamo la configurazione in base al tuo caso: freelance, team marketing, studio legale, e-commerce o reparto tecnico.",
    feat2Title: "Installazione assistita live",
    feat2Body:
      "Condivisione schermo su Teams e setup passo-passo fino al primo task completato dall'agente.",
    feat3Title: "Hardening essenziale",
    feat3Body:
      "Segmentazione dati, permessi minimi, backup e best practice per ridurre il rischio operativo.",
    feat4Title: "Integrazioni utili",
    feat4Body:
      "Impostiamo connessioni con strumenti che usi già: email, documenti, CRM o knowledge base interna.",
    feat5Title: "Template agente custom",
    feat5Body:
      "Creiamo un primo agente calibrato sui tuoi obiettivi, con prompt e regole operative riutilizzabili.",
    feat6Title: "Roadmap 30 giorni",
    feat6Body:
      "Esci dalla call con un piano concreto di miglioramento progressivo, senza dipendere sempre da supporto esterno.",
    agentsEyebrow: "Cosa possono fare gli agenti",
    agentsTitle:
      "Gli agenti possono far risparmiare tempo, ridurre ripetizioni e supportare decisioni quando sono progettati su workflow reali.",
    agent1Title: "Customer Support",
    agent1Body:
    ...
    processTitle: "Dal primo contatto al tuo agente operativo in 4 fasi.",
    step1Title: "Brief tecnico",
    step1Body:
      "Raccogliamo obiettivi, dispositivi e livello tecnico, poi definiamo stack e priorità.",
    step2Title: "Sessione Teams",
    step2Body:
      "Installazione live con controllo errori, ottimizzazione risorse e validazione finale.",
    step3Title: "Setup agente personalizzato",
    step3Body:
      "Definiamo ruolo, limiti, tono e task ricorrenti del tuo primo agente.",
    step4Title: "Consegna + Follow-up",
    step4Body:
      "Ricevi checklist operativa, file utili e supporto breve post-sessione per rifiniture.",
  ...
  ar: {
    ...
    heroSub:
      "جلسات خاصة عبر Microsoft Teams للإعداد واستراتيجية الوكلاء وتصميم سير العمل والأتمتة واختيار القنوات المناسبة مثل Telegram والبريد ولوحات التحكم والعمليات الخلفية.",
    heroCtaPrimary: "احجز استشارتك الآن",
    heroCtaSecondary: "عرض الباقات",
    heroBullet1: "إعداد كامل على Windows و macOS",
    heroBullet2: "تقوية أمنية أساسية لتقليل مخاطر البيانات",
    heroBullet3: "قالب وكيل مخصص حسب مجالك",
    heroBullet4: "جلسات مخصصة لمراجعة الأفكار وتحسين الوكلاء",
    panelTitle: "خطة تنفيذ الجلسة",
    panelStep1Title: "فحص تقني مسبق",
    panelStep1Body: "مراجعة الأجهزة والسحابة والحسابات المطلوبة",
    panelStep2Title: "تثبيت موجّه",
    panelStep2Body: "إعداد OpenClaw أو بنية الوكلاء وفق معمارية موصى بها",
    panelStep3Title: "وكيل شخصي",
    panelStep3Body: "تهيئة التعليمات والسياسات والمهام المتكررة",
    panelStep4Title: "تسليم الأدوات",
    panelStep4Body: "قائمة تشغيل وخطة احتياطية وخارطة تطوير 30 يومًا",
    ...
    whyTitle: "الاهتمام بوكلاء الذكاء الاصطناعي يتصاعد بسرعة، لكن الإعداد والاستراتيجية هما الفارق الحقيقي.",
    whyBody:
      "كثيرون ينطلقون من الضجة وينتهون بتدفقات هشة وتعليمات غير واضحة ومن دون اتجاه عملي. الاستشارة تقلل أخطاء البداية وتحول الأفكار العامة إلى وكلاء مستقرة ذات دور تشغيلي واضح.",
    riskTitle: "ما الذي تتفاداه مع إرشاد خبير",
    risk1: "تثبيتات هشة تتعطل مع أول تحديث",
    risk2: "صلاحيات واسعة قد تعرض ملفاتك الشخصية أو ملفات العمل",
    risk3: "تكاليف سحابية غير ضرورية بسبب إعداد غير محسّن",
    risk4: "وكلاء غير فعّالين لعدم توافقهم مع عملياتك الفعلية",
    offerEyebrow: "ماذا تتضمن الاستشارة",
    offerTitle: "من الإعداد إلى التنفيذ: وكلاء عمليّون للعمليات والدعم والبحث والنمو.",
    feat1Title: "بنية مخصصة لك",
    feat1Body:
      "نصمم التهيئة حسب حالتك: مستقل، فريق تسويق، مكتب قانوني، متجر إلكتروني أو فريق تقني.",
    feat2Title: "تثبيت مباشر بمرافقة",
    feat2Body:
      "مشاركة شاشة عبر Teams وخطوات واضحة حتى تنفيذ أول مهمة فعلية بواسطة الوكيل.",
    feat3Title: "تقوية أمنية أساسية",
    feat3Body:
      "تقسيم البيانات، أقل صلاحيات مطلوبة، نسخ احتياطي، وممارسات تقلل المخاطر التشغيلية.",
    feat4Title: "تكاملات مفيدة",
    feat4Body:
      "نربط OpenClaw بالأدوات التي تستخدمها فعليًا: البريد، المستندات، CRM أو قاعدة معرفة داخلية.",
    feat5Title: "قالب وكيل مخصص",
    feat5Body:
      "نبني وكيلًا أوليًا مطابقًا لأهدافك مع تعليمات وقواعد تشغيل قابلة لإعادة الاستخدام.",
    feat6Title: "خارطة 30 يومًا",
    feat6Body:
      "تنهي الجلسة مع خطة تطوير واقعية تساعدك على التقدم دون اعتماد دائم على دعم خارجي.",
    agentsEyebrow: "ما الذي يمكن للوكلاء فعله",
    agentsTitle:
      "يمكن للوكلاء توفير الوقت وتقليل التكرار ودعم القرارات عندما يتم تصميمهم حول سير عمل حقيقي.",
    ...
    processTitle: "من أول تواصل إلى وكيل جاهز للعمل عبر 4 مراحل.",
    step1Title: "تجميع المتطلبات",
    step1Body: "نحدد الأهداف والأجهزة والمستوى التقني ثم نختار البنية والأولويات.",
    step2Title: "جلسة Teams",
    step2Body: "تثبيت مباشر مع معالجة الأخطاء وتحسين الموارد والتحقق النهائي.",
    step3Title: "تهيئة الوكيل المخصص",
    step3Body: "نضبط الدور والحدود والأسلوب والمهام المتكررة لوكيلك الأول.",
    step4Title: "التسليم والمتابعة",
    step4Body: "تحصل على قائمة تشغيل وملفات مساعدة ومتابعة قصيرة بعد الجلسة للتحسين.",
